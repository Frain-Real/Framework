...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCNmode: return 4;
    case E_CCZNmode: return 4;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCNmode: return 1;
    case E_CCZNmode: return 1;
    case E_BImode: return 1;
    case E_QImode: return 1;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCNmode: return E_CCNmode;
    case E_CCZNmode: return E_CCZNmode;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_CCNmode: return 4*BITS_PER_UNIT;
    case E_CCZNmode: return 4*BITS_PER_UNIT;
    case E_BImode: return 1;
