...
#endif
  E_CCNmode,               /* config/avr/avr-modes.def:26 */
#define HAVE_CCNmode
#ifdef USE_ENUM_MODES
#define CCNmode E_CCNmode
#else
#define CCNmode ((void) 0, E_CCNmode)
#endif
  E_CCZNmode,              /* config/avr/avr-modes.def:27 */
#define HAVE_CCZNmode
#ifdef USE_ENUM_MODES
#define CCZNmode E_CCZNmode
#else
#define CCZNmode ((void) 0, E_CCZNmode)
#endif
...
#endif
  E_PSImode,               /* config/avr/avr-modes.def:20 */
#define HAVE_PSImode
#ifdef USE_ENUM_MODES
